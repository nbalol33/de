...
Используется простая HTTP-аутентикация по имени пользователя и паролю. Например, получить сведения об индексе `artem` в командной строке на spark-master-1.newprolab.com или spark-master-2.newprolab.com:
...
(далее в примерах аутентикация опущена)
